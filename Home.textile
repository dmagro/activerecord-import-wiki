...
activerecord-import is a library for bulk inserting data using ActiveRecord.  *Note:* activerecord-import requires Rails 3.x. It does not work with Rails 2.x. 

See the "docs for 3.x":http://rubydoc.info/gems/activerecord-import/0.3.1/ActiveRecord/Base
...
_To run examples on this page you'll need to first require activerecord-import, for that please take a brief look at [[Requiring]]_.
...
h2. Multi-level Example

Here's a multi-tier example using the @#import@ method:
